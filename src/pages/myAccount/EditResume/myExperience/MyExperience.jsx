      ...
      {experienceFields.map((experienceField, index) => (
        ...
        >
          ...
          <div className=" form-control">
            ...
            <input
              type="text"
              placeholder="Enter Your Jobs End Date"
              onChange={(e) =>
                handleChange(e.target.value, index, "companyName")
              }
              className={` text-black   input input-bordered  mb-3`}
            />
          </div>
          <div className=" form-control">
            ...
            <input
              type="text"
              placeholder="Enter When You Start This Job"
              onChange={(e) => handleChange(e.target.value, index, "startDate")}
              className={` text-black   input input-bordered  mb-3`}
            />
          </div>
          <div className=" form-control">
            ...
            <input
              type="text"
              placeholder="Enter Your Jobs End Date"
              onChange={(e) => handleChange(e.target.value, index, "endDate")}
              className={` text-black   input input-bordered  mb-3`}
            />
          </div>
          <div className=" form-control">
